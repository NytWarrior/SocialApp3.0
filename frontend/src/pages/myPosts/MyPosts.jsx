...
const MyPosts = () => {
    ...
    const { loading, posts } = useGetMyPost();
    ...
    return (
        <div className='flex justify-around'>
            ...
            <Menu />
            <div className='flex flex-col w-3/5 mt-10 p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
