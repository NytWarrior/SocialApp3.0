...
const Footer = () => {
    return (
        <footer className="body-font absolute shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0" style={{ position: 'fixed', bottom: 0, width: '100%' }}>
            <div className="container px-3 py-3 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 SocialApp —
                    <a href="/" className="text-white ml-1" rel="noopener noreferrer" target="_blank">@socialapp</a>
                </p>
